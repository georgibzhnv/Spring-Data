...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        if (postRepo.count() == 0) {
            List.of(
                    new Post("New in Spring", "Spring Boot is fancy...", "Georgi Bozhinov",
                            Set.of("spring", "java", "spring boot")),
                    new Post("Reactive Spring", "Web Flux is here...", "Georgi Bozhinov",
                            Set.of("spring", "java", "reactor")),
                    new Post("Easy to Test", "WebTestClient is easy...", "Georgi Bozhinov",
